...
If you'd like, I can:
- Start the server/client for you and walk through an example request
- Add a tiny smoke-test script that pings the three endpoints
- Add a `.gitignore` entry for `.env`
